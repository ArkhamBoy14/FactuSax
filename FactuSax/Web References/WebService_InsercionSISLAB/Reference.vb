...
'
Namespace WebService_InsercionSISLAB
    ...
    Partial Public Class Actualizar_Estatus
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.FactuSax.My.MySettings.Default.FactuSax_WebService_InsercionSISLAB_Actualizar_Estatus
        ...
        Public Function Actualizar(ByVal folio As String, ByVal uuid As String, ByVal estatus As String, ByVal rfc As String, ByVal folio_movimiento As String, ByVal fecha_facturado As Date) As Object
            Dim results() As Object = Me.Invoke("Actualizar", New Object() {folio, uuid, estatus, rfc, folio_movimiento, fecha_facturado})
        ...
        Private Sub OnActualizarOperationCompleted(ByVal arg As Object)
            If (Not (Me.ActualizarCompletedEvent) Is Nothing) Then
                ...
                RaiseEvent ActualizarCompleted(Me, New ActualizarCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
    ...
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.4084.0")>  _
    Public Delegate Sub ActualizarCompletedEventHandler(ByVal sender As Object, ByVal e As ActualizarCompletedEventArgs)
